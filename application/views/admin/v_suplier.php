...
<head>
  <title>Welcome To POS Apps</title>
...
<body>
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-lg-12">
        <h1 class="page-header">Data <small>Suplier</small>
          ...
          <form class="form-horizontal" method="post" action="<?php echo base_url() . 'admin/suplier/tambah_suplier' ?>">
            <div class="modal-body">
              ...
              <div class="form-group">
                ...
                <div class="col-xs-9">
                  <input name="email" class="form-control" type="text" placeholder="Email..." style="width:280px;" required>
                </div>
              </div>
            ...
            <form class="form-horizontal" method="post" action="<?php echo base_url() . 'admin/suplier/edit_suplier' ?>">
              <div class="modal-body">
                ...
                <div class="form-group">
                  <label class="control-label col-xs-3">Email</label>
                  <div class="col-xs-9">
                    <input name="email" class="form-control" type="text" placeholder="Email..." value="<?php echo $email; ?>" style="width:280px;" required>
                  </div>
                </div>
